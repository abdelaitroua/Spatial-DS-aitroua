...
dir_path = os.path.dirname(os.path.realpath(__file__)) # direct path that we are working in
file_name = dir_path + '/../Json_Files/colors.json'  # created a universal path
c = colors(file_name)
